 ...
 */
public class Mqtt3 implements MqttCallback {
	 ...
	 */
	public Mqtt3(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName,
			String password,InterestingEvent event) throws MqttException {
	...
	//	log("Publishing at: " + time + " to topic \"" + topicName + "\" qos " + qos);
		...
		message.setQos(qos);
		System.out.println("Publishing at:\t" + time + "  Topic:\t" + topic + "  Message:\t" + new String(message.getPayload())
				+ "  QoS:\t" + message.getQos());
	...
	public void messageArrived(String topic, MqttMessage message) throws MqttException {
		...
		String time = new Timestamp(System.currentTimeMillis()).toString();
		System.out.println("Recevied at:\t" + time + "  Topic:\t" + topic + "  Message:\t" + new String(message.getPayload())
				+ "  QoS:\t" + message.getQos());
		
		ie.interestingEvent(topic,message);
	}
